...
<cfscript>	
	if (CGI.HTTP_HOST CONTAINS "CornerStone") {
		VARIABLES.pageTitle = "Engineers and Surveyors - Building Resources - Stock Home Plans for Every Style - CornerStone Designs";	
	}
	else {
		VARIABLES.pageTitle = "Engineers and Surveyors - Building Resources - Your Family Architect - Architects Northwest";		
	}
    ...
    <cfmodule template="#Application.CTPath#layout.cfm" title="#VARIABLES.pageTitle#" recentlyViewedPlans="#VARIABLES.RecentlyViewedPlans#">
        <div id="copyrightMainContainer">            
            ...
            <div id="copyrightContainer">
                ...
                Engineer and surveyor information is coming soon.
            </div>
