...
<!--- Get Random New Plan, Award Winning Plan and Best Selling Plan --->
	<cfscript>
		...
		VARIABLES.SuncadiaPlan = Application.PlanService.getFeaturedPlanInfoForSearchSubGrouping(39);
		VARIABLES.GAPlan = Application.PlanService.getFeaturedPlanInfoForGarageAndAccessory();
	</cfscript>

<cfmodule template="#Application.CTPath#hpLayout.cfm" title="#VARIABLES.pageTitle#" recentlyviewedplans="#VARIABLES.RecentlyViewedPlans#">
            <div id="bodyWrapper">
            	<div id="quickSearch">
                	<div id="qsTop">
            ...
            <div id="hpSponsors">
                <div id="newPlan">
					<strong><a href="/plans/planSearchResults.cfm?Id=61" class="brownLink">SUNCADIA<br />PLANS</a></strong>
					<br />
					<cfoutput query="VARIABLES.SuncadiaPlan">
					<a href="/plans/detailedPlanInfo.cfm?PlanId=#PlanId#&nps=0" title="Click to view #PlanTitle# - Plan #PlanNumber#"><img src="#PlanThumbnail#" width="165" height="121" border=0 style="padding-top:5px;padding-bottom:5px;" alt="Carberry" /></a>
					<strong><a href="/plans/detailedPlanInfo.cfm?PlanId=#PlanId#&nps=0" title="Click to view The #PlanTitle# - Plan #PlanNumber#" class="brownLink">#PlanTitle#<br />#PlanNumber#</a></strong>
					<div style="font-size:12px;position:relative;padding:5px 0 5px 5px;">
						<div style="float:left;width:80px;text-align:left;margin:10px 0 10px 0;">
				...
				<div class="spacer"></div>
				<div id="newPlan" style="padding-top:10px;">
					<strong><a href="/plans/planSearchResults.cfm?Id=3" class="brownLink">GARAGE &<br />ACCESSORY PLANS</a></strong>
					<br />
					<cfoutput query="VARIABLES.GAPlan">
					<a href="/plans/detailedPlanInfo.cfm?PlanId=#PlanId#&nps=0" title="Click to view #PlanTitle# - Plan #PlanNumber#"><img src="#PlanThumbnail#" width="165" height="121" border=0 style="padding-top:5px;padding-bottom:5px;" alt="Carberry" /></a>
					<strong><a href="/plans/detailedPlanInfo.cfm?PlanId=#PlanId#&nps=0" title="Click to view The #PlanTitle# - Plan #PlanNumber#" class="brownLink">#PlanTitle#<br />#PlanNumber#</a></strong>
					<div style="font-size:12px;position:relative;padding:5px 0 5px 5px;">
						<div style="float:left;width:80px;text-align:left;margin:10px 0 10px 0;">
