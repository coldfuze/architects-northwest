<cfcomponent output="false">
	<cffunction name="getById" output="false" access="public">
		<cfargument name="id" required="true" />
 		<cfreturn createObject("component", "DesignerDAO").read(arguments.id)>
	</cffunction>

	<cffunction name="save" output="false" access="public" roles="admin">
		<cfargument name="obj" required="true" />
 		<cfscript>
			if( obj.getDesignerId() eq 0 )
			{
				return createObject("component", "DesignerDAO").create(arguments.obj);
			} else {
				return createObject("component", "DesignerDAO").update(arguments.obj);
			}
		</cfscript>
	</cffunction>
	...
	<cffunction name="deleteById" output="false" access="public" roles="admin">
		...
		<cfset createObject("component", "DesignerDAO").delete(obj)>
	</cffunction>
