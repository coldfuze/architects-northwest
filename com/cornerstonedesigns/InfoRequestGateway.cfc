<cfcomponent output="false">
	<cffunction name="getById" output="false" access="public" roles="admin">
		<cfargument name="id" required="true" />
 		<cfreturn createObject("component", "InfoRequestDAO").read(arguments.id)>
	</cffunction>

	<cffunction name="save" output="false" access="public">
		<cfargument name="obj" required="true" />
 		<cfscript>
			return createObject("component", "InfoRequestDAO").create(arguments.obj);
		</cfscript>
	</cffunction>
	...
	<cffunction name="deleteById" output="false" access="public" roles="admin">
		...
		<cfset createObject("component", "InfoRequestDAO").delete(obj)>
	</cffunction>
