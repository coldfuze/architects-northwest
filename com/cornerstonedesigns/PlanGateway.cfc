<cfcomponent output="false">
	<cffunction name="getById" output="false" access="public">
		<cfargument name="id" required="true" />
 		<cfreturn createObject("component", "PlanDAO").read(arguments.id)>
	</cffunction>

	<cffunction name="save" output="false" access="public" roles="admin">
		<cfargument name="obj" required="true" />
 		<cfscript>
			if( obj.getPlanId() eq 0 )
			{
				return createObject("component", "PlanDAO").create(arguments.obj);
			} else {
				return createObject("component", "PlanDAO").update(arguments.obj);
			}
		</cfscript>
	</cffunction>
	...
	<cffunction name="deleteById" output="false" access="public" roles="admin">
		...
		<cfset createObject("component", "PlanDAO").delete(obj)>
	</cffunction>
