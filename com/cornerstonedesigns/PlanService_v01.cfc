<cfcomponent extends="PlanGateway">
    ...
    <cffunction name="getPlanInfo" access="public" roles="" returntype="query" hint="This method returns detailed information about a plan">
        ...
        <cfquery datasource="#Application.DSN#" username="#Application.LimitedUser#" password="#Application.LimitedPassword#" name="ovpi">
        	SELECT	a.PlanId,
            		a.PlanNumber,
                    a.PlanTitle,
    ...
    <cffunction name="doesPlanHaveMedia" access="public" returntype="struct" hont="This method returns a boolean value as to whether a plan has video or audio, or a 360 degree animation">
        ...
        <cfscript>
			...
			mi.animationPath = VARIABLES.animationPath & '/' & mediaInfo.Animation;
			mi.videoPath = VARIABLES.videoPath & '/' & mediaInfo.Video;
			
			if (LEN(TRIM(mediaInfo.Video)) GT 0) {
				VARIABLES.existingVideo = VARIABLES.videoUploadPath & '\' & mediaInfo.Video;
			...
			if (LEN(TRIM(mediaInfo.Animation)) GT 0) {
				VARIABLES.existingAnimation = VARIABLES.animationUploadPath & '\' & mediaInfo.Animation;
