...
<!--- Change the type of plans searched (if applicable) --->
    <cfif NOT IsDefined("URL.pvt")>
		<cfscript>
            Session.SearchSubGroupingId = 28;
...
<!--- Convert Session to Local Variables --->
	<cfscript>
        VARIABLES.SearchSubGroupingId = Session.SearchSubGroupingId;
...
<!--- Get Plan Information --->
	<cfscript>
		// Get the page title
		VARIABLES.PageTitle = Application.SearchSubGroupingService.getSearchSubGroupingTitle(VARIABLES.SearchSubGroupingId);
	</cfscript>
    
    <cfquery datasource="#Application.DSN#" username="#Application.LimitedUser#" password="#Application.LimitedPassword#" name="gi">
    	SELECT 	a.PlanId
        FROM	PlanToSearchSubGrouping a
        		INNER JOIN [Plan] b ON a.PlanId = b.PlanId
        WHERE	SearchSubGroupingId = <cfqueryparam cfsqltype="cf_sql_integer" value="#VARIABLES.SearchSubGroupingId#">
    </cfquery>
...
<!--- Get Quick Search Business Logic --->
    ...
    <cfmodule template="#Application.CTPath#layout.cfm" title="#VARIABLES.pageTitleBar#" recentlyViewedPlans="#VARIABLES.RecentlyViewedPlans#" minHeight="#VARIABLES.minHeight#">
    	<div id="planSearchResultsContainer">
            ...
            <div id="planSearchResultsCenterColumn">
                ...
                <div class="planSearchResultsOptions">
                	<div class="planSort">
                    	Sort By:
                    	<cfform action="planSearchResults.cfm" method="get" name="sbt">
                	...
                	<div class="detailViewNav">
                    	Detail<br />
						View<br />
						<a href="planSearchResults.cfm?pvt=detailed"><img src="/assets/images/btn_DetailView.gif" width="30" height="30" border="0" alt="View Plans in Detail View" /></a>
                    </div>
                    <div class="galleryViewNav">
                    	Gallery<br />
						View<br />
						<a href="planSearchResults.cfm?pvt=gallery"><img src="/assets/images/btn_GalleryView.gif" width="30" height="30" border="0" alt="View Plans in Gallery View" /></a>
                    </div>
                    <div class="plansPerPageOption">
                    	Plans Per Page
                    	<cfform action="planSearchResults.cfm" method="get" name="ppp">
