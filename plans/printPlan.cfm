<cfscript>
	if (CGI.HTTP_HOST CONTAINS "CornerStone") {
		VARIABLES.fileName = "CornerStone Designs Detailed Plan Information";
	}
	else {
		VARIABLES.fileName = "Architects Northwest Detailed Plan Information";
	}
</cfscript>

<cfheader name="Content-Disposition" value="inline; filename=plandetails.pdf"> 
...
<!--- Get Plan Information --->
	<cfscript>
		...
		if (CGI.HTTP_HOST CONTAINS "CornerStone") {
			VARIABLES.FileName = VARIABLES.PlanLabel & '-Architects-Northwest-INC.pdf';
		}
		else {
			VARIABLES.FileName = VARIABLES.PlanLabel & '-CornerStone-Designs.pdf';
		}
	</cfscript>

<cfdocument format="pdf" margintop="0.25" marginbottom="0.6" marginright="1" marginleft="1" overwrite="yes" saveasname="#VARIABLES.fileName#" fontembed="yes">
	<html>
    	<head>
            <style>
				BODY {
        ...
        <body>
            ...
            <cfif CGI.HTTP_HOST CONTAINS "CornerStone">
                <a href="http://www.cornerstonedesigns.com"><img src="file:///D:\home\architectsnw.com\wwwroot\assets\printPlanImages\CornerStoneDesignsHeader.png" border=0 width="100%"></a>
            ...
            <cfelse>
                <a href="http://www.architectsnw.com"><img src="file:///D:\home\architectsnw.com\wwwroot\assets\printPlanImages\ArchitectsNorthwestHeader.png" border=0 width="100%"></a>
                <div style="font-size:18px;text-transform:uppercase;font-weight:bold;margin-top:0.05in;padding:0.025in;text-align:center;height:21px;background-color:#caccbb;">
                    <cfoutput>#UCASE(VARIABLES.PlanLabel)#</cfoutput>
                </div>
            </cfif>
            ...
            <cfif VARIABLES.hasMainFloorPlan EQ 1>
            	...
            	<strong style="text-decoration:underline;font-size:14px;">MAIN FLOOR</strong><br />
               	<cfoutput><img src="file:///D:\home\architectsnw.com\wwwroot\#Replace(VARIABLES.mainFloorPlanPath,'/','\','all')#" alt="Main Floor Plan" /></cfoutput>
				</div>                
            </cfif>
            <cfif VARIABLES.hasUpperFloorPlan EQ 1>
            	...
            	<strong style="text-decoration:underline;font-size:14px;">UPPER FLOOR</strong><br />
               	<cfoutput><img src="file:///D:\home\architectsnw.com\wwwroot\#Replace(VARIABLES.UpperFloorPlanPath,'/','\','all')#" alt="Upper Floor Plan" /></cfoutput>
				</div>                
            </cfif>
            <cfif VARIABLES.hasLowerFloorPlan EQ 1>
            	...
            	<strong style="text-decoration:underline;font-size:14px;">LOWER FLOOR</strong><br />
               	<cfoutput><img src="file:///D:\home\architectsnw.com\wwwroot\#Replace(VARIABLES.LowerFloorPlanPath,'/','\','all')#" alt="Lower Floor Plan" /></cfoutput>
				</div>                
            </cfif>
            <cfif VARIABLES.hasThirdFloorPlan EQ 1>
            	...
            	<strong style="text-decoration:underline;font-size:14px;">THIRD FLOOR</strong><br />
               	<cfoutput><img src="file:///D:\home\architectsnw.com\wwwroot\#Replace(VARIABLES.ThirdFloorPlanPath,'/','\','all')#" alt="Third Floor Plan" /></cfoutput>
				</div>                
            </cfif>
            <cfdocumentitem type="pagebreak" />
                 <cfif CGI.HTTP_HOST CONTAINS "CornerStone">
