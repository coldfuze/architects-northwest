...
<!--- Get Plan Information --->
	<cfscript>
		...
		if (LEN(TRIM(VARIABLES.ZipCode)) GT 0 AND VARIABLES.ZipCode NEQ 0) {
			...
			VARIABLES.planPricingInfo.LowerFloorSF = VARIABLES.PlanInfo.LowerFloorSF;
			VARIABLES.planPricingInfo.ThirdFloorSF = VARIABLES.PlanInfo.ThirdFloorSF;
			...
			VARIABLES.planPricingInfo.HasExistingMaterialList = VARIABLES.PlanInfo.HasExistingMaterialList;
...
<cfscript>	
    ...
    <cfmodule template="#Application.CTPath#layout.cfm" title="#VARIABLES.pageTitle#" recentlyviewedplans="#VARIABLES.RecentlyViewedPlans#" planid="#VARIABLES.PlanId#" similarplanstodisplay="#VARIABLES.SimilarPlansToDisplay#" scrollsimilarplans="#VARIABLES.ScrollSimilarPlans#" totalsimilarplans="#VARIABLES.SimilarPlans.RecordCount#" alertmessage="#VARIABLES.addPlanAlert#">
        <div id="dpTopContentContainer">
        	<div id="highLevelPlanInfo">
                ...
                <div id="mediaLinks">
                    ...
                    <ul type="square" id="mediaLinkList">
                        ...
                        <cfif VARIABLES.Media.hasYouTube EQ 1><li><cfoutput><a class="planSpec" href="javascript: newWindow = openWin( 'youTube.cfm?PlanId=#VARIABLES.PlanId#', 'youTube', 'width=1280,height=675,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=0,resizable=0' ); newWindow.focus()">YouTube Video</a></cfoutput></li></cfif>
					</ul>
                </div>
                </cfif>
                <br clear="all" />
            ...
            <div id="planPhotoAnimationContainer">
				...
				<cfif IsDefined("VARIABLES.galleriaCode")>
                    ...
                    <script type="text/javascript">
						$('#planPhotoAnimation').jshowoff({ speed:5000, links: false });
                    </script>
                <cfelse>
        ...
        <cfif VARIABLES.SimilarPlans.recordCount GT 1000>
        	...
        	<div id="emptyPlanPricingContainer">
                <div id="emptyPlanPricingContentContainer">
                	<cfform name="ppi" method="get" action="detailedplaninfo.cfm" style="height:25px;">
                    	<cfinput type="hidden" name="PlanId" value="#VARIABLES.PlanId#">
                        Please enter the zip code of your building site, then select the Go! button to view pricing information for this house plan.
