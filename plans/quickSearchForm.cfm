<div id="quickSearchContainer">
                    ...
                    <div id="qsContainer">
                        ...
                        <cfform name="sbps" id="sbps" method="get" style="margin:0;white-space:nowrap;">
                            ...
                            <div class="quickSearchLeft">
                                ...
                                <cfselect name="BedroomId" query="VARIABLES.br" display="Bedroom" value="BedroomId" selected="#VARIABLES.Bedrooms#" queryPosition="below" style="font-size:12px;width:84px;">
                            ...
                            <div class="quickSearchRight">
                                ...
                                <cfselect name="FullBathId" query="VARIABLES.fbr" display="FullBathroom" value="FullBathroomId" selected="#VARIABLES.Bathrooms#" queryPosition="below" style="font-size:12px;width:84px;">
                                    <option value="100">Any</option>
                                </cfselect>
                            </div>
                            </cfform>
                            ...
                            <cfdiv id="qsPlanCount" bind="url:/quickSearchPlans.cfm?PlanTypeId={PlanTypeId}&Bedrooms={BedroomId}&Bathrooms={FullBathId}&SquareFootageLow={SquareFootageLow}&SquareFootageHigh={SquareFootageHigh}" />
