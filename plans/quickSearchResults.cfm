...
<!--- Change the Plans Per Page, if applicable --->
	...
	<cfscript>
        VARIABLES.QuickSearchPlans = Session.QuickSearchPlans;
        ...
        if (ListLen(VARIABLES.QuickSearchPlans) LT VARIABLES.lastPlan) {
            VARIABLES.lastPlan = ListLen(VARIABLES.QuickSearchPlans);	
        }
        pdLen = ListLen(VARIABLES.QuickSearchPlans);
...
<cfscript>
   pai = StructNew();
   pai.totalrecords = ListLen(VARIABLES.QuickSearchPlans);
   ...
   VARIABLES.paging = Application.PagingService.generatePaging(pai);
    ...
    <cfscript>
		if (ListLen(VARIABLES.QuickSearchPlans) GT 0) {
			VARIABLES.pic = StructNew();
			VARIABLES.pic.Plans = VARIABLES.QuickSearchPlans;
		...
		// Page Titles
		VARIABLES.PageTitle = 'Quick Search Plan Results';
	...
	<cfmodule template="#Application.CTPath#planLayout.cfm" title="#VARIABLES.pageTitleBar#" recentlyViewedPlans="#VARIABLES.RecentlyViewedPlans#" minHeight="#VARIABLES.minHeight#" cannedSearch="1">
            <div id="centerColumn">
                ...
                <cfif ListLen(VARIABLES.QuickSearchPlans) EQ 0>
                ...
                <div class="planSearchResultsNavigation">
                	<div class="planSearchResultCount">
                    	Results: <cfoutput>#VARIABLES.FirstPlan#-#VARIABLES.lastPlan# of #ListLen(VARIABLES.QuickSearchPlans)#</cfoutput>
                    </div>
