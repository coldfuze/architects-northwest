    	<div id="qs">
            ...
            <div id="qsContainer">
                ...
                <cfform name="sbps" id="sbps" style="margin:0;white-space:nowrap;">
                    ...
                    <cfdiv id="qsPlanCount" bind="url:quickSearchCount.cfm?PlanTypeId={PlanTypeId}&Bedrooms={Bedrooms}&Bathrooms={Bathrooms}&SquareFootageLow={SquareFootageLow}&SquareFootageHigh={SquareFootageHigh}" />
