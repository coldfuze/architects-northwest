...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="/assets/skins/tango/skin.css" />
        ...
        <cfif Attributes.PlanId NEQ 0>
			<script>
                jQuery(document).ready(function() {										
                    ...
                    jQuery('.recentlyViewedPlansCarousel').jcarousel({
...
<cfif thisTag.ExecutionMode EQ "End">
	<cfif IsDefined("VARIABLES.RecentlyViewedPlanInfo")>
        <div id="recentlyViewedPlansContainer">
            ...
            <div id="recentlyViewedPlansContentContainer">
                <cfif VARIABLES.ScrollRecentlyViewedPlans EQ 1><div id="second-carousel" class="recentlyViewedPlansCarousel jcarousel-skin-tango"><cfelse><div id="first-carousel" class="recentlyViewedPlansCarousel jcarousel-skin-tangoNN"></cfif>
                    <ul>
                    <cfoutput query="VARIABLES.RecentlyViewedPlanInfo"><li style="width:175px;height:150px;text-align:center;font-size:14px;font-weight:bold;text-transform:uppercase;">#PlanTitle#<br /><a href="/plans/detailedplaninfo.cfm?PlanId=#PlanId#&nps=1"><img src="/assets/planImages/#PlanId#/planthu/#ImageFile#" title="#PlanTitleLong#" border=0/></a></li></cfoutput>
                    </ul>
                </div>
            </div>
        </div>
