...
<cfscript>	
	if (CGI.HTTP_HOST CONTAINS "CornerStone") {
		VARIABLES.pageTitle = "Neighborhood Designs - Design Services - Stock Home Plans for Every Style - CornerStone Designs";	
	}
	else {
		VARIABLES.pageTitle = "Neighborhood Designs - Design Services - Your Family Architect - Architects Northwest";		
	}
    ...
    <cfmodule template="#Application.CTPath#layout.cfm" title="#VARIABLES.pageTitle#" recentlyViewedPlans="#VARIABLES.RecentlyViewedPlans#">
        <div id="copyrightMainContainer">            
            ...
            <div id="copyrightContainer">
                ...
                Neighborhood Design information is coming soon.
            </div>
