<cfif ArrayLen(Session.PlanImages) GT 0>
    <cfscript>
		...
		// Set the photo path
		uploadPath = ExpandPath("/assets/tempPhotos");
    ...
    <cfdirectory action="list" directory="#uploadPath#" name="tf">
    <cfloop query="tf">
    	<cfscript>
			VARIABLES.df = uploadPath & '/' & Name;
		</cfscript>
    	<cffile action="delete" file="#VARIABLES.df#">
    </cfloop>
