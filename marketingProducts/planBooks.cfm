...
<cfscript>	
	if (CGI.HTTP_HOST CONTAINS "CornerStone") {
		VARIABLES.pageTitle = "Plan Books - Marketing Products - Stock Home Plans for Every Style - CornerStone Designs";	
	}
	else {
		VARIABLES.pageTitle = "Plan Books - Marketing Products - Your Family Architect - Architects Northwest";		
	}
    ...
    <cfmodule template="#Application.CTPath#layout.cfm" title="#VARIABLES.pageTitle#" recentlyViewedPlans="#VARIABLES.RecentlyViewedPlans#">
        <div id="copyrightMainContainer">            
            ...
            <div id="copyrightContainer">
                ...
                Plan Book Information is coming soon.
            </div>
