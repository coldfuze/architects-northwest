...
<cfscript>	
	if (CGI.HTTP_HOST CONTAINS "CornerStone") {
		VARIABLES.pageTitle = "Photo Gallery - Marketing Products - Stock Home Plans for Every Style - CornerStone Designs";	
	}
	else {
		VARIABLES.pageTitle = "Photo Gallery - Marketing Products - Your Family Architect - Architects Northwest";		
	}
